...
export const siteOrigin = (() => {
  ...
  if (process.env.CONTEXT === 'production') return 'https://zendaya-tech.github.io/squash';
  if (process.env.DEPLOY_PRIME_URL) return process.env.DEPLOY_PRIME_URL;
  console.warn(
    'Unable to determine site origin, defaulting to https://zendaya-tech.github.io/squash',
  );
  return 'https://zendaya-tech.github.io/squash';
})();
